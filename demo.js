...
{
	if (region.bS.an === region.b6.an)
	{
		return 'on line ' + region.bS.an;
	}
	return 'on lines ' + region.bS.an + ' through ' + region.b6.an;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cH: fragment, b8: host, cf: path, ch: port_, ck: protocol, cl: query};
	});
...
var $author$project$Demo$DismissibleDrawer$defaultModel = {v: false, a2: 0};
...
var $author$project$Demo$Lists$defaultModel = {aP: 'Star', Y: $elm$core$Set$empty, av: $elm$core$Maybe$Nothing, a3: 'Star'};
var $author$project$Demo$Menus$defaultModel = {v: false};
var $author$project$Demo$ModalDrawer$defaultModel = {v: false, a2: 0};
var $author$project$Demo$PermanentDrawer$defaultModel = {a2: 0};
...
var $author$project$Demo$Selects$defaultModel = {a6: ''};
...
var $author$project$Demo$TextFields$defaultModel = {a6: ''};
...
var $author$project$Main$defaultModel = function (key) {
	return {cz: $author$project$Demo$Buttons$defaultModel, W: $author$project$Demo$Cards$defaultModel, y: false, X: $author$project$Demo$Checkbox$defaultModel, Z: $author$project$Demo$Chips$defaultModel, _: $author$project$Demo$DataTable$defaultModel, aa: $author$project$Demo$DenseTopAppBar$defaultModel, ab: $author$project$Demo$Dialog$defaultModel, ae: $author$project$Demo$DismissibleDrawer$defaultModel, cD: $author$project$Demo$Drawer$defaultModel, af: $author$project$Demo$Elevation$defaultModel, ag: $author$project$Demo$Fabs$defaultModel, ah: $author$project$Demo$FixedTopAppBar$defaultModel, ak: $author$project$Demo$IconButton$defaultModel, al: $author$project$Demo$ImageList$defaultModel, b9: key, am: $author$project$Demo$LayoutGrid$defaultModel, ao: $author$project$Demo$LinearProgress$defaultModel, ap: $author$project$Demo$Lists$defaultModel, aq: $author$project$Demo$Menus$defaultModel, ar: $author$project$Demo$ModalDrawer$defaultModel, at: $author$project$Demo$PermanentDrawer$defaultModel, au: $author$project$Demo$ProminentTopAppBar$defaultModel, av: $author$project$Demo$RadioButtons$defaultModel, ax: $author$project$Demo$Ripple$defaultModel, ay: $author$project$Demo$Selects$defaultModel, az: $author$project$Demo$ShortCollapsedTopAppBar$defaultModel, aA: $author$project$Demo$ShortTopAppBar$defaultModel, aB: $author$project$Demo$Slider$defaultModel, aC: $author$project$Demo$Snackbar$defaultModel, aD: $author$project$Demo$StandardTopAppBar$defaultModel, aE: $author$project$Demo$Switch$defaultModel, aG: $author$project$Demo$TabBar$defaultModel, aI: $author$project$Demo$TextFields$defaultModel, aJ: $author$project$Demo$Theme$defaultModel, c1: $author$project$Demo$TopAppBar$defaultModel, aN: $author$project$Demo$Typography$defaultModel, a: $author$project$Demo$Url$Button};
};
...
var $author$project$Demo$Url$fromUrl = function (url) {
	return $author$project$Demo$Url$fromString(
		A2($elm$core$Maybe$withDefault, '', url.cH));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				...
				var enter = 13;
				var backspace = 8;
				return (_Utils_eq(keyCode, enter) && (!$elm$core$String$isEmpty(trimmedInput))) ? _Utils_update(
					model,
					{
						B: '',
					...
					}) : ((_Utils_eq(keyCode, backspace) && $elm$core$String$isEmpty(model.B)) ? _Utils_update(
					model,
					{
						k: A2(
							$elm$core$List$take,
...
var $author$project$Material$Snackbar$setOnActionButtonClick = F2(
	function (onActionButtonClick, _v0) {
		...
		return _Utils_update(
			message_,
			{
				bB: $elm$core$Maybe$Just(onActionButtonClick)
			});
	});
			...
			case 5:
				...
				return A2(
					...
					A2(
						...
						A2($author$project$Demo$Buttons$update, msg_, model.cz)));
			case 6:
				var msg_ = msg.a;
				return A2(
					$elm$core$Tuple$mapSecond,
			...
			case 8:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Z: A2($author$project$Demo$Chips$update, msg_, model.Z)
						}),
					$elm$core$Platform$Cmd$none);
			case 9:
				var msg_ = msg.a;
			...
			case 32:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							c1: A2($author$project$Demo$TopAppBar$update, msg_, model.c1)
						}),
					$elm$core$Platform$Cmd$none);
			case 17:
				var msg_ = msg.a;
...
var $author$project$Material$Button$config = {bb: _List_Nil, bk: false, ac: false, aj: $elm$core$Maybe$Nothing, c: $elm$core$Maybe$Nothing, bD: $elm$core$Maybe$Nothing, bV: $elm$core$Maybe$Nothing, aL: true, a5: false};
...
var $author$project$Material$Button$button = F3(
	function (variant, config_, label) {
		var additionalAttributes = config_.bb;
...
var $author$project$Material$Button$setOnClick = F2(
	function (onClick, _v0) {
		...
		return _Utils_update(
			config_,
			{
				bD: $elm$core$Maybe$Just(onClick)
			});
	});
...
var $author$project$Demo$Buttons$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Buttons$heroButtons,
		cV: 'Buttons communicate an action a user can take. They are typically placed throughout your UI, in places like dialogs, forms, cards, and toolbars.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Button'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-buttons'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-button')
		},
		c0: 'Button'
	};
};
...
var $author$project$Material$Card$actionsElt = function (content) {
	var _v0 = content.T;
	if (!_v0.$) {
		var buttons = _v0.a.cz;
		var icons = _v0.a.cK;
		var fullBleed = _v0.a.bq;
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
...
var $author$project$Material$Card$config = {bb: _List_Nil, bH: false};
...
var $author$project$Material$Card$actions = function (_v0) {
	var buttons = _v0.cz;
	var icons = _v0.cK;
	return {cz: buttons, bq: false, cK: icons};
};
...
var $author$project$Material$IconButton$config = {bb: _List_Nil, ac: false, b: $elm$core$Maybe$Nothing, bD: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$Cards$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Cards$heroCard,
		cV: 'Cards contain content and actions about a single subject.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Card'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-cards'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-card')
		},
		c0: 'Card'
	};
};
...
var $author$project$Material$Drawer$Dismissible$config = {bb: _List_Nil, bE: $elm$core$Maybe$Nothing, v: false};
var $author$project$Material$List$Config = $elm$core$Basics$identity;
var $author$project$Material$List$config = {bb: _List_Nil, be: false, bk: false, by: false, bX: false, c3: false, b$: false};
...
var $author$project$Material$TopAppBar$config = {bb: _List_Nil, bk: false, bo: false};
	...
	function (_v0, nodes) {
		...
		return $author$project$Material$List$Item$Internal$ListItem(
			_Utils_update(
				config_,
				{
					cQ: A2($author$project$Material$List$Item$listItemView, config_, nodes)
				}));
	});
...
var $author$project$Demo$CatalogPage$resourcesList = function (_v0) {
	var materialDesignGuidelines = _v0.cO;
	var documentation = _v0.cC;
	var sourceCode = _v0.c_;
	return A3(
...
var $author$project$Demo$CatalogPage$view = F3(
	function (lift, catalogPageConfig, catalogPage) {
		var toggleCatalogDrawer = catalogPageConfig.bm ? catalogPageConfig.b4 : catalogPageConfig.ce;
		return A2(
			$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							A2(
								...
								A2($author$project$Material$Drawer$Dismissible$setOpen, catalogPageConfig.bm, $author$project$Material$Drawer$Dismissible$config)),
							_List_fromArray(
								[
									A2(
									...
									[
										...
										A2(
											...
											A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$text(catalogPage.c0)
													])),
											A2(
												$elm$core$List$cons,
												A2(
												...
												A2(
													$elm$core$List$cons,
													A2($elm$html$Html$div, $author$project$Demo$CatalogPage$hero, catalogPage.cI),
													A2(
														$elm$core$List$cons,
														A2(
															$elm$html$Html$h2,
														...
														A2(
															$elm$core$List$cons,
															$author$project$Demo$CatalogPage$resourcesList(catalogPage.cW),
															A2(
																$elm$core$List$cons,
																A2(
																	$elm$html$Html$h2,
...
var $author$project$Material$Checkbox$config = {bb: _List_Nil, ac: false, a$: $elm$core$Maybe$Nothing, cp: $elm$core$Maybe$Nothing, aL: true};
...
var $author$project$Material$Checkbox$setOnChange = F2(
	function (onChange, _v0) {
		...
		return _Utils_update(
			config_,
			{
				a$: $elm$core$Maybe$Just(onChange)
			});
	});
...
var $author$project$Demo$Checkbox$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Checkbox$heroCheckboxes(model),
		cV: 'Checkboxes allow the user to select multiple options from a set.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Checkbox'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-checkboxes'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-checkbox')
		},
		c0: 'Checkbox'
	};
};
...
var $author$project$Material$Chip$Action$config = {bb: _List_Nil, c: $elm$core$Maybe$Nothing, bD: $elm$core$Maybe$Nothing};
...
var $author$project$Material$ChipSet$Choice$chipSet = F2(
	function (config_, chips) {
		...
		var onChange = config_.a$;
		var toLabel = config_.cu;
		var additionalAttributes = config_.bb;
		return A3(
			$elm$html$Html$node,
			'mdc-chip-set',
...
var $author$project$Material$Chip$Choice$config = {bb: _List_Nil, c: $elm$core$Maybe$Nothing};
...
var $author$project$Material$ChipSet$Choice$config = function (_v0) {
	var toLabel = _v0.cu;
	return {bb: _List_Nil, a$: $elm$core$Maybe$Nothing, i: $elm$core$Maybe$Nothing, cu: toLabel};
};
...
var $author$project$Material$Chip$Filter$config = {bb: _List_Nil, c: $elm$core$Maybe$Nothing, a$: $elm$core$Maybe$Nothing, i: false};
...
var $author$project$Material$Chip$Input$config = {bb: _List_Nil, ca: $elm$core$Maybe$Nothing, bD: $elm$core$Maybe$Nothing, cd: $elm$core$Maybe$Nothing, a5: $elm$core$Maybe$Nothing};
...
var $author$project$Material$Chip$Input$setOnDelete = F2(
	function (onDelete, _v0) {
		...
		return _Utils_update(
			config_,
			{
				cd: $elm$core$Maybe$Just(onDelete)
			});
	});
...
var $author$project$Demo$Chips$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Chips$heroChips(model),
		cV: 'Chips are compact elements that allow users to enter information, select a choice, filter content, or trigger an action.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Chips'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-chips'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-chips')
		},
		c0: 'Chips'
	};
};
...
var $author$project$Material$DataTable$checkboxCell = F2(
	function (attributes, config_) {
		return $author$project$Material$DataTable$CheckboxCell(
			{m: attributes, bj: config_});
	});
var $author$project$Material$DataTable$Config = $elm$core$Basics$identity;
var $author$project$Material$DataTable$config = {bb: _List_Nil, b: $elm$core$Maybe$Nothing};
	...
	return A2(
		...
		$author$project$Material$DataTable$config,
		{
			cs: A2(
				...
				function (data_) {
					...
					return A2(
						row,
						{
							a$: $author$project$Demo$DataTable$ItemSelected(desert),
			...
			ct: A2(
				headerRow,
				{
					a$: allSelected ? $author$project$Demo$DataTable$AllUnselected : $author$project$Demo$DataTable$AllSelected,
					cp: allSelected ? $author$project$Material$Checkbox$checked : (allUnselected ? $author$project$Material$Checkbox$unchecked : $author$project$Material$Checkbox$indeterminate)
				},
...
var $author$project$Demo$DataTable$standardDataTable = function () {
	...
	return A2(
		...
		$author$project$Material$DataTable$config,
		{
			cs: A2($elm$core$List$map, row, $author$project$Demo$DataTable$data),
			ct: _List_fromArray(
				[
...
var $author$project$Demo$DataTable$view = function (model) {
	return {
		...
		cI: $author$project$Demo$DataTable$heroDataTable,
		cV: 'Data tables display information in a way that’s easy to scan, so that users can look for patterns and insights.',
		cW: {
			cC: $elm$core$Maybe$Just('https://material.io/components/web/catalog/data-tables/'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-data-tables'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-data-table')
		},
		c0: 'Data Table'
	};
};
...
var $author$project$Demo$DenseTopAppBar$view = function (model) {
	return {
		cG: $author$project$Material$TopAppBar$denseFixedAdjust,
		c1: A2(
			$author$project$Material$TopAppBar$regular,
...
var $author$project$Material$Dialog$config = {bb: _List_Nil, bE: $elm$core$Maybe$Nothing, v: false};
...
var $author$project$Material$Dialog$setOnClose = F2(
	function (onClose, _v0) {
		...
		return _Utils_update(
			config_,
			{
				bE: $elm$core$Maybe$Just(onClose)
			});
	});
...
var $author$project$Material$Radio$config = {bb: _List_Nil, aT: false, ac: false, a$: $elm$core$Maybe$Nothing, aL: true};
...
var $author$project$Demo$Dialog$confirmationDialog = function (model) {
	...
	return A2(
				...
				$author$project$Material$Dialog$config)),
		{
			...
			c0: $elm$core$Maybe$Just('Phone ringtone')
		});
};
...
var $author$project$Demo$Dialog$scrollableDialog = function (model) {
	return A2(
				...
				$author$project$Material$Dialog$config)),
		{
			...
			c0: $elm$core$Maybe$Just('The Wonderful Wizard of Oz')
		});
};
...
var $author$project$Demo$Dialog$simpleDialog = function (model) {
	...
	return A2(
				...
				$author$project$Material$Dialog$config)),
		{
			...
			c0: $elm$core$Maybe$Just('Select an account')
		});
};
var $author$project$Demo$Dialog$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Dialog$heroDialog,
		cV: 'Dialogs inform users about a specific task and may contain critical information, require decisions, or involve multiple tasks.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Dialog'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-dialogs'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-dialog')
		},
		c0: 'Dialog'
	};
};
...
var $author$project$Material$List$Divider$config = {bb: _List_Nil, br: false, bI: false};
...
var $author$project$Demo$DismissibleDrawer$view = function (model) {
	return {
		cD: A2(
			...
			A2($author$project$Demo$DrawerPage$drawerBody, $author$project$Demo$DismissibleDrawer$SetSelectedIndex, model.a2)),
		cS: $elm$core$Maybe$Just($author$project$Demo$DismissibleDrawer$ToggleDrawer),
		cY: $elm$core$Maybe$Nothing,
		c0: 'Dismissible Drawer'
	};
};
var $author$project$Material$Drawer$Permanent$Config = $elm$core$Basics$identity;
var $author$project$Material$Drawer$Permanent$config = {bb: _List_Nil};
...
var $author$project$Material$Drawer$Permanent$drawer = F2(
	function (_v0, nodes) {
		var additionalAttributes = _v0.bb;
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				A2(
...
var $author$project$Demo$Drawer$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Drawer$heroDrawer,
		cV: 'The navigation drawer slides in from the left and contains the navigation destinations for your app.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Drawer'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-navigation-drawer'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-drawer')
		},
		c0: 'Drawer'
	};
};
...
var $author$project$Demo$Elevation$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Elevation$heroElevation,
		cV: 'Elevation is the relative depth, or distance, between two surfaces along the z-axis.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Elevation'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-elevation'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-elevation')
		},
		c0: 'Elevation'
	};
};
...
var $author$project$Material$Fab$config = {bb: _List_Nil, bn: false, bx: false, bD: $elm$core$Maybe$Nothing};
var $author$project$Material$Fab$Extended$Config = $elm$core$Basics$identity;
var $author$project$Material$Fab$Extended$config = {bb: _List_Nil, bn: false, c: $elm$core$Maybe$Nothing, bD: $elm$core$Maybe$Nothing, a5: false};
...
var $author$project$Demo$Fabs$view = function (model) {
	return {
		...
		cV: 'Floating action buttons represents the primary action in an application. Only one floating action button is recommended per screen to represent the most common action.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Fab'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-fab'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/blob/master/packages/mdc-fab/')
		},
		c0: 'Floating Action Button'
	};
};
...
var $author$project$Demo$FixedTopAppBar$view = function (model) {
	return {
		cG: $author$project$Material$TopAppBar$fixedAdjust,
		c1: A2(
			$author$project$Material$TopAppBar$regular,
...
var $author$project$Material$IconToggle$config = {bb: _List_Nil, ac: false, b: $elm$core$Maybe$Nothing, a_: false, a$: $elm$core$Maybe$Nothing};
	...
	return {
		cB: _List_fromArray(
			[
				...
				{bz: 'favorite_border', bF: 'favorite'}),
				A2(
				$elm$html$Html$h3,
				_List_fromArray(
					[$author$project$Material$Typography$subtitle1]),
		...
		cV: 'Icons are appropriate for buttons that allow a user to take actions or make a selection, such as adding or removing a star to an item.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-IconButton'),
			cO: $elm$core$Maybe$Just('https://material.io/design/components/buttons.html#toggle-button'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-icon-button')
		},
		c0: 'Icon Button'
	};
};
var $author$project$Material$ImageList$Config = $elm$core$Basics$identity;
var $author$project$Material$ImageList$config = {bb: _List_Nil, aW: false, b_: false};
...
var $author$project$Material$ImageList$listItemElt = F2(
	function (config_, listItem) {
		var masonry = config_.aW;
		var href = listItem.aj;
		var additionalAttributes = listItem.bb;
...
var $author$project$Material$ImageList$Item$config = {bb: _List_Nil, aj: $elm$core$Maybe$Nothing, cL: '', b: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$ImageList$view = function (model) {
	return {
		...
		cV: 'Image lists display a collection of images in an organized grid.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-ImageList'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-image-list'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-image-list')
		},
		c0: 'Image List'
	};
};
...
var $author$project$Demo$LayoutGrid$view = function (model) {
	return {
		...
		cI: $author$project$Demo$LayoutGrid$heroGrid,
		cV: 'Material design’s responsive UI is based on a 12-column grid layout.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-LayoutGrid'),
			cO: $elm$core$Maybe$Nothing,
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-layout-grid')
		},
		c0: 'Layout Grid'
	};
};
...
var $author$project$Material$LinearProgress$buffered = F2(
	function (config_, data) {
		return A2(
			...
			A2($author$project$Material$LinearProgress$Buffered, data.a1, data.b2),
			config_);
	});
var $author$project$Material$LinearProgress$Config = $elm$core$Basics$identity;
var $author$project$Material$LinearProgress$config = {bb: _List_Nil, bg: false, bO: false};
...
var $author$project$Demo$LinearProgress$view = function (model) {
	return {
		...
		cV: 'Progress indicators display the length of a process or express an unspecified wait time.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-LinearProgress'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-progress-indicators'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-linear-progress')
		},
		c0: 'Linear Progress Indicator'
	};
};
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$author$project$Material$List$Item$setSelected,
						_Utils_eq(model.a3, label) ? $elm$core$Maybe$Just($author$project$Material$List$Item$activated) : $elm$core$Maybe$Nothing,
						$author$project$Material$List$Item$config))),
			_List_fromArray(
				[
					A2(
...
var $author$project$Demo$Lists$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Lists$heroList,
		cV: 'Lists present multiple line items vertically as a single continuous element.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-List'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-lists'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-list')
		},
		c0: 'List'
	};
};
...
var $author$project$Material$Menu$config = {bb: _List_Nil, bE: $elm$core$Maybe$Nothing, v: false, bM: false};
...
var $author$project$Demo$Menus$view = function (model) {
	return {
		...
		cV: 'Menus display a list of choices on a transient sheet of material.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Menu'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-menus'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-menu')
		},
		c0: 'Menu'
	};
};
...
var $author$project$Material$Drawer$Modal$config = {bb: _List_Nil, bE: $elm$core$Maybe$Nothing, v: false};
...
var $author$project$Demo$ModalDrawer$view = function (model) {
	return {
		cD: A2(
			...
			A2($author$project$Demo$DrawerPage$drawerBody, $author$project$Demo$ModalDrawer$SetSelectedIndex, model.a2)),
		cS: $elm$core$Maybe$Just($author$project$Demo$ModalDrawer$OpenDrawer),
...
var $author$project$Demo$PermanentDrawer$view = function (model) {
	return {
		cD: A2(
			$author$project$Material$Drawer$Permanent$drawer,
			$author$project$Material$Drawer$Permanent$config,
			A2($author$project$Demo$DrawerPage$drawerBody, $elm$core$Basics$identity, model.a2)),
...
var $author$project$Demo$ProminentTopAppBar$view = function (model) {
	return {
		cG: $author$project$Material$TopAppBar$prominentFixedAdjust,
		c1: A2(
...
var $author$project$Material$FormField$config = {bb: _List_Nil, bd: false, bp: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, bD: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$RadioButtons$view = function (model) {
	return {
		...
		cV: 'Buttons communicate an action a user can take. They are typically placed throughout your UI, in places like dialogs, forms, cards, and toolbars.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Radio'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-radio-buttons'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-radio')
		},
		c0: 'Radio Button'
	};
};
...
var $author$project$Material$Ripple$config = {bb: _List_Nil, bh: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$Ripple$view = function (model) {
	return {
		...
		cV: 'Ripples are visual representations used to communicate the status of a component or interactive element.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Ripple'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-states'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-ripple')
		},
		c0: 'Ripple'
	};
};
var $author$project$Material$Select$Config = $elm$core$Basics$identity;
var $author$project$Material$Select$config = {bb: _List_Nil, ac: false, b: $elm$core$Maybe$Nothing, a$: $elm$core$Maybe$Nothing, bN: false, bZ: false, a6: $elm$core$Maybe$Nothing};
	...
	function (_v0, _v1) {
		...
		return $elm$core$Maybe$Just(
			$elm$html$Html$Attributes$selected(
				(!_Utils_eq(topConfig.a6, $elm$core$Maybe$Nothing)) && _Utils_eq(topConfig.a6, config_.a6)));
	});
...
var $author$project$Material$Select$Option$config = {bb: _List_Nil, ac: false, E: _List_Nil, a6: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$Selects$focusSelect = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Demo$Selects$heroSelects = function (model) {
	return A2(
		...
		A2(
			...
			$author$project$Demo$Selects$SetValue,
			A2(
	...
	return {
		cB: _List_fromArray(
			[
				...
				$author$project$Demo$Selects$focusSelect
			]),
		cI: _List_fromArray(
			[
				$author$project$Demo$Selects$heroSelects(model)
			]),
		cV: 'Selects allow users to select from a single-option menu. It functions as a wrapper around the browser\'s native <select> element.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Select'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-text-fields'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-select')
		},
		c0: 'Select'
	};
};
...
var $author$project$Demo$ShortCollapsedTopAppBar$view = function (model) {
	return {
		cG: $author$project$Material$TopAppBar$shortFixedAdjust,
		c1: A2(
...
var $author$project$Material$Slider$config = {bb: _List_Nil, ac: false, ad: false, bl: false, aX: $elm$core$Maybe$Nothing, aY: $elm$core$Maybe$Nothing, bG: $elm$core$Maybe$Nothing, bT: $elm$core$Maybe$Nothing, a6: $elm$core$Maybe$Nothing};
...
var $author$project$Material$Slider$setOnInput = F2(
	function (onInput, _v0) {
		...
		return _Utils_update(
			config_,
			{
				bG: $elm$core$Maybe$Just(onInput)
			});
	});
...
var $author$project$Demo$Slider$view = function (model) {
	return {
		...
		cV: 'Sliders let users select from a range of values by moving the slider thumb.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Slider'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-sliders'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-slider')
		},
		c0: 'Slider'
	};
};
...
var $author$project$Material$Snackbar$config = function (_v0) {
	var onClosed = _v0.cR;
	return {bb: _List_Nil, bf: false, cR: onClosed};
};
...
var $author$project$Material$Snackbar$actionButtonClickHandler = F2(
	function (messageId, _v0) {
		var onActionButtonClick = _v0.bB;
		return A2(
			$elm$core$Maybe$map,
			A2(
				$elm$core$Basics$composeL,
			...
			[
				...
				A2(
					...
					$author$project$Material$Snackbar$config(
						{cR: $author$project$Demo$Snackbar$SnackbarClosed})),
				model.l)
			]),
		cI: _List_fromArray(
			[$author$project$Demo$Snackbar$heroMessage]),
		cV: 'Snackbars provide brief feedback about an operation through a message at the bottom of the screen.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Snackbar'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-snackbar'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-snackbar')
		},
		c0: 'Snackbar'
	};
};
...
var $author$project$Demo$Startpage$imageListItems = _List_fromArray(
	[
		{c: 'images/buttons_180px.svg', d: 'Raised and flat buttons', c0: 'Button', a: $author$project$Demo$Url$Button},
		{c: 'images/cards_180px.svg', d: 'Various card layout styles', c0: 'Card', a: $author$project$Demo$Url$Card},
		{c: 'images/checkbox_180px.svg', d: 'Multi-selection controls', c0: 'Checkbox', a: $author$project$Demo$Url$Checkbox},
		{c: 'images/chips_180px.svg', d: 'Chips', c0: 'Chips', a: $author$project$Demo$Url$Chips},
		{c: 'images/data_table_180px.svg', d: 'Data Table', c0: 'Data Table', a: $author$project$Demo$Url$DataTable},
		{c: 'images/dialog_180px.svg', d: 'Secondary text', c0: 'Dialog', a: $author$project$Demo$Url$Dialog},
		{c: 'images/drawer_180px.svg', d: 'Various drawer styles', c0: 'Drawer', a: $author$project$Demo$Url$Drawer},
		{c: 'images/elevation_180px.svg', d: 'Shadow for different elevations', c0: 'Elevation', a: $author$project$Demo$Url$Elevation},
		{c: 'images/floating_action_button_180px.svg', d: 'The primary action in an application', c0: 'FAB', a: $author$project$Demo$Url$Fab},
		{c: 'images/icon_button_180px.svg', d: 'Toggling icon states', c0: 'Icon Button', a: $author$project$Demo$Url$IconButton},
		{c: 'images/image_list_180px.svg', d: 'An Image List consists of several items, each containing an image and optionally supporting content (i.e. a text label)', c0: 'Image List', a: $author$project$Demo$Url$ImageList},
		{c: 'images/layout_grid_180px.svg', d: 'Grid and gutter support', c0: 'Layout Grid', a: $author$project$Demo$Url$LayoutGrid},
		{c: 'images/list_180px.svg', d: 'Item layouts in lists', c0: 'List', a: $author$project$Demo$Url$List},
		{c: 'images/linear_progress_180px.svg', d: 'Fills from 0% to 100%, represented by bars', c0: 'Linear progress', a: $author$project$Demo$Url$LinearProgress},
		{c: 'images/menu_180px.svg', d: 'Pop over menus', c0: 'Menu', a: $author$project$Demo$Url$Menu},
		{c: 'images/radio_180px.svg', d: 'Single selection controls', c0: 'Radio', a: $author$project$Demo$Url$RadioButton},
		{c: 'images/ripple_180px.svg', d: 'Touch ripple', c0: 'Ripple', a: $author$project$Demo$Url$Ripple},
		{c: 'images/form_field_180px.svg', d: 'Popover selection menus', c0: 'Select', a: $author$project$Demo$Url$Select},
		{c: 'images/slider_180px.svg', d: 'Range Controls', c0: 'Slider', a: $author$project$Demo$Url$Slider},
		{c: 'images/snackbar_180px.svg', d: 'Transient messages', c0: 'Snackbar', a: $author$project$Demo$Url$Snackbar},
		{c: 'images/switch_180px.svg', d: 'On off switches', c0: 'Switch', a: $author$project$Demo$Url$Switch},
		{c: 'images/tabs_180px.svg', d: 'Tabs organize and allow navigation between groups of content that are related and at the same level of hierarchy', c0: 'Tab Bar', a: $author$project$Demo$Url$TabBar},
		{c: 'images/form_field_180px.svg', d: 'Single and multiline text fields', c0: 'Text field', a: $author$project$Demo$Url$TextField},
		{c: 'images/ic_theme_24px.svg', d: 'Using primary and accent colors', c0: 'Theme', a: $author$project$Demo$Url$Theme},
		{c: 'images/top_app_bar_180px.svg', d: 'Container for items such as application title, navigation icon, and action items.', c0: 'Top App Bar', a: $author$project$Demo$Url$TopAppBar},
		{c: 'images/fonts_180px.svg', d: 'Type hierarchy', c0: 'Typography', a: $author$project$Demo$Url$Typography}
	]);
...
var $author$project$Material$Switch$config = {bb: _List_Nil, aT: false, ac: false, a$: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$Switch$view = function (model) {
	return {
		...
		cI: $author$project$Demo$Switch$heroSwitch(model),
		cV: 'Switches communicate an action a user can take. They are typically placed throughout your UI, in places like dialogs, forms, cards, and toolbars.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Switch'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-switches'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-switch')
		},
		c0: 'Switch'
	};
};
...
var $author$project$Material$Tab$config = {
	b0: false,
	bb: _List_Nil,
	cB: {c: $elm$core$Maybe$Nothing, b: ''},
	bD: $elm$core$Maybe$Nothing
};
var $author$project$Material$TabBar$Config = $elm$core$Basics$identity;
var $author$project$Material$TabBar$config = {bb: _List_Nil, bc: $elm$core$Maybe$Nothing, aV: false, bw: false, bR: false};
...
var $author$project$Material$TabBar$viewTab = F2(
	function (barConfig, tab) {
		var indicatorSpansContent = barConfig.aV;
		var tabConfig = tab;
		var additionalAttributes = tabConfig.bb;
		var content = tabConfig.cB;
		return A2(
			$elm$html$Html$button,
			_Utils_ap(
				A2(
...
var $author$project$Demo$TabBar$view = function (model) {
	return {
		...
		cV: 'Tabs organize and allow navigation between groups of content that are related and at the same level of hierarchy. The Tab Bar contains the Tab Scroller and Tab components.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-TabBar'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-tabs'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-tab-bar')
		},
		c0: 'Tab Bar'
	};
};
var $author$project$Material$TextField$Config = $elm$core$Basics$identity;
var $author$project$Material$TextField$config = {bb: _List_Nil, ac: false, ai: false, b: $elm$core$Maybe$Nothing, ca: $elm$core$Maybe$Nothing, aX: $elm$core$Maybe$Nothing, bt: $elm$core$Maybe$Nothing, aY: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing, a$: $elm$core$Maybe$Nothing, bG: $elm$core$Maybe$Nothing, bJ: $elm$core$Maybe$Nothing, a0: $elm$core$Maybe$Nothing, bN: false, bT: $elm$core$Maybe$Nothing, a5: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing, bZ: true, a6: $elm$core$Maybe$Nothing};
var $author$project$Material$HelperText$Config = $elm$core$Basics$identity;
var $author$project$Material$HelperText$config = {bb: _List_Nil, bK: false};
...
var $author$project$Material$HelperText$persistentCs = function (_v0) {
	var config_ = _v0;
	return config_.bK ? $elm$core$Maybe$Just(
...
var $author$project$Material$TextArea$config = {bb: _List_Nil, bi: $elm$core$Maybe$Nothing, ac: false, ai: false, b: $elm$core$Maybe$Nothing, bt: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing, a$: $elm$core$Maybe$Nothing, bG: $elm$core$Maybe$Nothing, a0: $elm$core$Maybe$Nothing, bN: false, bP: $elm$core$Maybe$Nothing, bZ: true, a6: $elm$core$Maybe$Nothing};
...
var $author$project$Demo$TextFields$view = function (model) {
	return {
		...
		cV: 'Text fields allow users to input, edit, and select text. Text fields typically reside in forms but can appear in other places, like dialog boxes and search.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-TextField'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-text-fields'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-textfield')
		},
		c0: 'Text Field'
	};
};
...
var $author$project$Demo$Theme$view = function (model) {
	return {
		...
		cV: 'Color in Material Design is inspired by bold hues juxtaposed with muted environments, deep shadows, and bright highlights.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Theme'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-color-theming'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-theme')
		},
		c0: 'Theme'
	};
};
...
var $author$project$Demo$TopAppBar$view = function (model) {
	return {
		...
		cV: 'Top App Bars are a container for items such as application title, navigation icon, and action items.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-TopAppBar'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-app-bar-top'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-top-app-bar')
		},
		c0: 'Top App Bar'
	};
};
...
var $author$project$Demo$TopAppBarPage$view = F2(
	function (lift, _v0) {
		var topAppBar = _v0.c1;
		var fixedAdjust = _v0.cG;
		return A2(
			$elm$html$Html$map,
			lift,
			A2(
...
var $author$project$Demo$Typography$view = function (model) {
	return {
		...
		cV: 'Roboto is the standard typeface on Android and Chrome.',
		cW: {
			cC: $elm$core$Maybe$Just('https://package.elm-lang.org/packages/aforemny/material-components-web-elm/latest/Material-Typography'),
			cO: $elm$core$Maybe$Just('https://material.io/go/design-typography'),
			c_: $elm$core$Maybe$Just('https://github.com/material-components/material-components-web/tree/master/packages/mdc-typography')
		},
		c0: 'Typography'
	};
};
var $author$project$Main$body = function (model) {
	var catalogPageConfig = {b4: $author$project$Main$CloseCatalogDrawer, bm: model.y, ce: $author$project$Main$OpenCatalogDrawer, a: model.a};
	var _v0 = model.a;
	switch (_v0.$) {
		case 0:
		...
		case 1:
			return A3(
				...
				catalogPageConfig,
				$author$project$Demo$Buttons$view(model.cz));
		case 2:
			return A3(
				$author$project$Demo$CatalogPage$view,
		...
		case 27:
			return A3(
				...
				catalogPageConfig,
				$author$project$Demo$TopAppBar$view(model.c1));
		case 28:
			return A2(
...
var $author$project$Main$view = function (model) {
	return {
		...
		c0: 'Material Components for Elm'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{cN: $author$project$Main$init, cT: $author$project$Main$UrlChanged, cU: $author$project$Main$UrlRequested, c$: $author$project$Main$subscriptions, c2: $author$project$Main$update, c4: $author$project$Main$view});
